...
| Projekt | Kurz | Stack |
|---|---|---|
| **[multiagent-consistent-story-creator](https://github.com/fatihaltiok/multiagent-consistent-story-creator)** `v1.0.0` | **Multi-Agent-Workflow** für **konsistente illustrierte Geschichten & Videos** — selbstkorrigierender Konsistenz-Loop, Soul-ID-Identitätstreue (ArcFace), autoregressive Frame-Kette, eigenes Memory | LangGraph · FastAPI · OpenRouter · gpt-image |
